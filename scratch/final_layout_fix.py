...
# Fix for Long Title Overflow and Abstract Overlap
start_pdf = -1
...
if start_pdf != -1:
    new_content = [
        ...
        '    """Export formatted paper with multi-line title and overlap protection."""\n',
        ...
        '    y_start_top = 25\n',
        '\n',
        '    # 1. Title (Multi-cell for wrap protection)\n',
        ...
        '    pdf.ln(12)\n',
        '\n',
        '    # Capture the exact Y position where body content MUST start\n',
        ...
        '        if current_col == 0:\n',
        '            current_col = 1\n',
        '            # Safety: If still on first page, start at y_after_header, otherwise top\n',
        ...
        '    """Export formatted paper as DOCX with overlap protection."""\n',
    ...
    with open(file_path, "w", encoding="utf-8") as f:
        f.writelines(lines)
    print("Successfully fixed Title Overflow and Abstract Overlap")
else:
