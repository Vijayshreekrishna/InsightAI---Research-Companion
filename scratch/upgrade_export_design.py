...
# Full Design Upgrade for PDF and Word Exports
start_pdf = -1
...
if start_pdf != -1:
    new_content = [
        ...
        '    """Export formatted paper as PDF with full design style (Spacing, Justification, Bolding)."""\n',
        ...
        '    \n',
        '    # Dynamic Line Height based on user choice\n',
        '    lh = 6 * line_spacing\n',
        '\n',
        '    # 1. Title (Bold, Centered, Large)\n',
        ...
        '            # Header: Bold, Uppercase, Underlined-look (Border)\n',
        '            pdf.set_font(pdf_font, "B", config["section_size"])\n',
        '            pdf.cell(col_width, 10, label.upper(), ln=True, border="B")\n',
        '            pdf.ln(2)\n',
        '            # Body: Justified\n',
        '            pdf.set_font(pdf_font, "", config["body_size"])\n',
        '            pdf.multi_cell(col_width, lh, clean_text_for_pdf(str(content)), align="J")\n',
        '            pdf.ln(5)\n',
        '    else:\n',
        '        for label, key in sections:\n',
        '            content = paper_data.get(key, "")\n',
        ...
        '    """Export formatted paper as DOCX with full design style (Justification, Columns, Spacing)."""\n',
        ...
        '\n',
        '    # 2. Abstract & Keywords (Indented & Styled)\n',
    ...
    with open(file_path, 'w', encoding='utf-8') as f:
        f.writelines(lines)
    print("Successfully upgraded export design and styles")
else:
