...
if start_index != -1:
    new_func = [
        'def generate_formatted_paper(title: str, text: str, citation_style: str = "IEEE", word_limit: int = 2500, extra_rules: str = "") -> dict:\n',
        ...
        '    CONSTRAINTS:\n',
        '    1. Title: {title}\n',
        '    2. Citation Style: {citation_style} (Apply only to the References section)\n',
        '    3. Target Length: Maintain original text density.\n',
        '    4. Custom Rules: {extra_rules if extra_rules else "None specified."}\n',
        '\n',
    ...
    # Replace from start_index to the end of the file (since it's the last function)
