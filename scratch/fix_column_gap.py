...
# Fixing the PDF Column Switcher and Flow
start_pdf = -1
...
if start_pdf != -1:
    new_content = [
        ...
        '    pdf = PDF()\n',
        '    pdf.alias_nb_pages()\n',
        '    pdf.set_auto_page_break(auto=False) # Manual column handling\n',
        '    pdf.add_page()\n',
        '    \n',
        '    font_map = {\n',
        ...
        '    y_start_top = 25 # Standard top start for new pages/columns\n',
        '\n',
        ...
        '        if current_col == 0:\n',
        '            current_col = 1\n',
        '            pdf.set_xy(margin + col_width + col_gap, y_start_top if pdf.page > 1 or pdf.get_y() > y_after_header else y_after_header)\n',
        '        else:\n',
        '            pdf.add_page()\n',
        '            current_col = 0\n',
        ...
        '                # Manual split to handle column wrap\n',
        '                lines_list = pdf.multi_cell(col_width, lh, txt, align="J", split_only=True)\n',
        '                for line in lines_list:\n',
        '                    if pdf.get_y() > 270: \n',
        '                        switch_col_or_page()\n',
        '                    pdf.set_x(margin if current_col == 0 else margin + col_width + col_gap)\n',
        '                    pdf.cell(col_width, lh, line, ln=True, align="J")\n',
        '                pdf.ln(4)\n',
        '    else:\n',
        ...
        '        cols.set(qn("w:num"), "2")\n',
        '        cols.set(qn("w:space"), "400") # Narrower gutter for Word\n',
        '    \n',
        '    # Body Sections\n',
        '    sections = [\n',
    ...
    with open(file_path, "w", encoding="utf-8") as f:
        f.writelines(lines)
    print("Successfully fixed Column Switching and Right-Side Gap")
else:
