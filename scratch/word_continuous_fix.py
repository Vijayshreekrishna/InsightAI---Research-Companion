...
# Fix for Continuous Columns in Word (No new page)
start_pdf = -1
...
if start_pdf != -1:
    new_content = [
        ...
        '    """Export formatted paper as DOCX with continuous sections."""\n',
    ...
    with open(file_path, "w", encoding="utf-8") as f:
        f.writelines(lines)
    print("Successfully implemented Continuous Section Break for Word")
else:
